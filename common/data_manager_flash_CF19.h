#ifndef _DATA_MANAGER_FLASH_CF19_H
#define _DATA_MANAGER_FLASH_CF19_H
...
#define SECTOR_1_FONT_SIZE                  (0x00D10000)                        // 13M + 64K
#define SECTOR_1_FONT_END					(SECTOR_BASE + SECTOR_1_FONT_SIZE)  // 0x00D2 0000
...
//-----------------------------------------------------------------------------------------------------------------------
// OTA
#define SECTOR_2_BASE						SECTOR_1_FONT_END                   // 0x00D2 0000
#define SECTOR_2_SIZE                       (0x00130000)                // 1216K
#define SECTOR_2_END						(SECTOR_2_BASE + SECTOR_2_SIZE)     // 0x00E5 0000
...
//-----------------------------------------------------------------------------------------------------------------------
//
#define	SECTOR_0_BASE						SECTOR_2_END                        // 0x00E5 0000
#define SECTOR_0_SIZE                       (0x00040000)                // 256K
#define	SECTOR_0_END						(SECTOR_0_BASE + SECTOR_0_SIZE)     // 0x00E9 0000
...
//-----------------------------------------------------------------------------------------------------------------------
#define	SECTOR_01_BASE						SECTOR_0_END                        // 0x00E9 0000
...
//-----------------------------------------------------------------------------------------------------------------------
// ���̿ռ�
#define	SECTOR_02_BASE						SECTOR_01_END                       // 0x00E9 0000
#define SECTOR_02_SIZE                      (0x00150000)                // 404K + 808M + 102K
#define	SECTOR_02_END						(SECTOR_02_BASE + SECTOR_02_SIZE)   // 0x00FE 0000
...
//-----------------------------------------------------------------------------------------------------------------------
#define	SECTOR_03_BASE						SECTOR_02_END                       // 0x00FE 0000
