#ifndef __BOARD_GLOBAL_BUILD_CFG_H__
#define __BOARD_GLOBAL_BUILD_CFG_H__
...
#if defined(__CW_JL_INTER_FLASH_16M__)
#define CONFIG_FLASH_SIZE                       FLASH_SIZE_16M   //配置FLASH大小
#elif defined(__CW_JL_INTER_FLASH_8M__)
#define CONFIG_FLASH_SIZE                       FLASH_SIZE_8M    //配置FLASH大小
#else
#define CONFIG_FLASH_SIZE                       FLASH_SIZE_2M    //配置FLASH大小
#endif

#if defined(__CW_JL_FLASH_8M__)
#define CONFIG_EXTERN_FLASH_SIZE                FLASH_SIZE_8M    //配置外挂FLASH大小
#elif defined(__CW_JL_FLASH_16M__)
#define CONFIG_EXTERN_FLASH_SIZE                FLASH_SIZE_16M    //配置外挂FLASH大小
#elif defined(__CW_JL_FLASH_32M__)
 ...
 */
#define CONFIG_EXTERN_USER_VM_FLASH_SIZE        (0) // (128*1024)  //配置外挂FLASH大小
