...
extern bool  app_rec_running(void);

#define GUI_MUSIC_FILELIST_ITEM_H       50
#define GUI_MUSIC_FILELIST_BASE_ID      30

/////////////////////////////////////////////////////////////////////////////////////////////////////////
static const gui_layout_list_struct gui_window_record_filelist_layout =
{
...
static const gui_screen_struct gui_screen_record_filelist =
{
	.type = TYPE_GUI_LAYOUT_LIST,
	.space_x = 0,
	.space_y = 0,
	.order = 0,
	.layout_config = &gui_window_record_filelist_layout,
};

// list
static char g_filename_buff[192];
static const gui_font_struct gui_text_record_filename =
{
...
static const gui_mix_struct gui_item_record_filename[] =
{
	{
		.data = &gui_text_record_filename,
	},
};

static const gui_widget_struct gui_widget_record_filename = {
        .id = 0,
        ...
        .visible= 1,
        .child_num = 1,
        .children = gui_item_record_filename
};

static void app_window_record_filelist_init_box(gui_box_struct* box, unsigned int box_idx)
{
    if (box->id == 0) {
        box->id = GUI_MUSIC_FILELIST_BASE_ID+box_idx;
        box->type = TYPE_GUI_CONTROL_LAYOUT_ITEM;
        box->widget = &gui_widget_record_filename;
        box->x = 0;
        box->y = 0;
...
static void app_sport_list_refresh()
{
    ...
    gui_surface_struct* surface = gui_surface_get_surface(&gui_screen_record_filelist);
    ...
    if (surface != NULL) {
        for (box_idx=0; box_idx<box_num; box_idx++) {
            ...
            if (NULL != music_file_get_name(box_idx, g_filename_buff)) {
                ...
                if (box != NULL) {
                    app_window_record_filelist_init_box(box, box_idx);
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////
static void app_window_record_filelist_init(void *buf)
{
}

static void app_window_record_filelist_load(void *buf)
{
	gui_surface_struct* surface = gui_surface_get_surface(&gui_screen_record_filelist);
...
static void app_window_record_filelist_entry(void *buf)
{
    if (!app_rec_running()) {
...
static void app_window_record_filelist_exit()
{
    app_music_player_stop();
}

static void app_window_record_filelist_destroy()
{
}


//
static void app_window_record_filelist_click_on_layout_item(gui_click_layout_struct *event)
{
...
static void app_window_record_filelist_rolkey_handler(void* buf)
{
...
{
    SYS_DEBUG("app: rec_fl, app_window_appmod_ind_handler");
    application_goto_main();
}


//
static const app_window_event_struct app_window_record_filelist_events[] =
{
    {.id = EVENT_ROLKEY,     .handler = app_window_record_filelist_rolkey_handler},
    {.id = EVENT_APPMOD_IND, .handler = app_window_appmod_ind_handler},
};

const gui_window_struct app_window_record_filelist =
{
	.screen = &gui_screen_record_filelist,

	.init = app_window_record_filelist_init,
	.load = app_window_record_filelist_load,
	.entry = app_window_record_filelist_entry,
	.exit = app_window_record_filelist_exit,
	.destroy = app_window_record_filelist_destroy,

	.click_on_layout_item = app_window_record_filelist_click_on_layout_item,

    .event_num = countof(app_window_record_filelist_events),
    .events = app_window_record_filelist_events,
};
